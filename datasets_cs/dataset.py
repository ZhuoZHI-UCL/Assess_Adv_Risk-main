...
import datasets_cs.cifar10 as cifar10_input
from datasets_cs.imagenet import ImagenetValidData
...
def load_imagenet(n_ex = 1000, size=224):
    IMAGENET_SL = size
    IMAGENET_PATH = data_path_join('/scratch/uceezzz/Dataset/Adv_risk_main/IN_Sample_1000')
